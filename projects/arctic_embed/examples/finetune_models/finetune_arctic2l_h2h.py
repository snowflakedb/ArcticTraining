...
DATA_PATH = "s3://ml-dev-sfc-or-dev-misc1-k8s/cortexsearch/biencoder/fine_tune_data_arctic_training_format/synthetic_experiment_1/unified_h2h/Arctic2L_batched_512/data/"
...
checkpoint_dir = f"s3://ml-dev-sfc-or-dev-misc1-k8s/cortexsearch/training/checkpoints/arctic2l/synthetic-experiment-1/unified-h2h-{ts}"
local_cache_dir = "/scratch/checkpoints-temp-arctic2l-h2h"
...
wconf = WandBConfig(
    ...
    name=f"arctic2l-synthetic-experiment-1-unified-h2h-{ts}",
)
