...
# DATA_PATH = "s3://ml-dev-sfc-or-dev-misc1-k8s/cortexsearch/biencoder/fine_tune_data_arctic_training_format/unified_ft/batched_tokenized_Qwen_Qwen3_0.6B/batched_512/"
...
# DATA_PATH = "s3://ml-dev-sfc-or-dev-misc1-k8s/cortexsearch/biencoder/fine_tune_data_arctic_training_format/unified_ft/batched_tokenized_Qwen_Qwen3_0.6B/batched_16/"
DATA_PATH = "s3://ml-dev-sfc-or-dev-misc1-k8s/cortexsearch/biencoder/fine_tune_data_arctic_training_format/unified_IR/batched_tokenized_Qwen_Qwen3_0.6B/batched_512/"
...
checkpoint_dir = f"s3://ml-dev-sfc-or-dev-misc1-k8s/cortexsearch/training/checkpoints/qwenpoint6b/IR-{ts}"
local_cache_dir = "/scratch/checkpoint-saving"

mconf = BiencoderModelConfig(
    name_or_path="/scratch/qwen/hf_encoder", 
    pooling="last_token", 
    dtype=DType.FP32, 
