...
DATA_PATH = "s3://ml-dev-sfc-or-dev-misc1-k8s/cortexsearch/biencoder/fine_tune_data_arctic_training_format/synthetic_experiment_1/unified_synthetic/Arctic2L_batched_512/data/"
...
checkpoint_dir = f"s3://ml-dev-sfc-or-dev-misc1-k8s/cortexsearch/training/checkpoints/arctic2l/synthetic-experiment-1/unified-synthetic-{ts}"
local_cache_dir = "/scratch/checkpoints-temp-arctic2l-synthetic"

mconf = BiencoderModelConfig(
    name_or_path="/scratch/arctic2l-pretrained", 
    pooling="first_token", 
    dtype=DType.BF16, 
...
wconf = WandBConfig(
    ...
    name=f"arctic2l-synthetic-experiment-1-unified-synthetic-{ts}",
)
