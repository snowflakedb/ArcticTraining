...
DATA_PATH = "s3://ml-dev-sfc-or-dev-misc1-k8s/cortexsearch/biencoder/fine_tune_data_arctic_training_format/synthetic_experiment_1/unified_synthetic/batched_512/data/"
...
checkpoint_dir = f"s3://ml-dev-sfc-or-dev-misc1-k8s/cortexsearch/training/checkpoints/arctic2m/synthetic-experiment-1/unified-synthetic-{ts}"
local_cache_dir = "/scratch/checkpoints-temp-synthetic"
...
wconf = WandBConfig(
    ...
    name=f"arctic2m-synthetic-experiment-1-unified-synthetic-{ts}",
)
