...
OUTPUT_PATH="/checkpoint/speculator/llama-3.1-8b/Dec-20"
CHECKPOINT_PATH="/checkpoint/speculator/llama-3.1-8b/Dec-20/checkpoint"
mkdir -p $OUTPUT_PATH
...
if [ -e ${HOSTFILE} ]; then
	...
	HF_HOME=/data-fast/hf-hub deepspeed train_speculator.py ${TRAIN_ARGS} 
