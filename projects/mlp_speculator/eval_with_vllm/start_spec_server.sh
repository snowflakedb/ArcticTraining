...
#vllm serve /home/yak/jaeseong/Meta-Llama-3.1-8B-Instruct --swap_space 16 --disable-log-requests --enable-chunked-prefill --speculative_model $1 --use-v2-block-manager --num-speculative-tokens $2 --gpu-memory-utilization 0.8
vllm serve /checkpoint/tmp/huggingface/llama33_swiftkv \
