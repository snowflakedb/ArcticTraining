...
class CommBuilder(CUDAOpBuilder):
    ...
    def sources(self):
        sources = [
            "arctic_training/kernels/comm/comm.cu",
            "arctic_training/kernels/comm/comm.cpp",
        ]
    ...
    def include_paths(self):
        include_dirs = ["arctic_training/kernels/includes", "arctic_training/kernels/comm"]
        prefix = self.get_prefix()
