...
from ..mixtral.modeling_mixtral import MixtralForSequenceClassification
from ..mixtral.modeling_mixtral import MixtralForTokenClassification
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        if cache_position is None:
            past_seen_tokens = past_key_values.get_seq_length() if past_key_values is not None else 0  # type: ignore[attr-defined]
